...
public class Level7Activity extends AppCompatActivity {
    ...
    private final String[] dialogs = {
            "Almost there! Just the study room left.",
            "Two sofas AND a TV AND a plant… this is chaos.",
            "The walls are making this really difficult.",
            "I need to plan every move carefully.",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getBooleanExtra("skipDialog", false)) {
            ...
            gameView.loadLevel(LevelData.LEVEL_7);
        } else {
            dialogBox.setText(dialogs[dialogIndex]);
        }

        findViewById(R.id.level7Root).setOnClickListener(v -> {
        ...
        gameView.setOnLevelCompleteListener(() -> {
            ...
            result.putExtra("nextLevel", "com.speed.sofasogood.game.levels.Level8Activity");
