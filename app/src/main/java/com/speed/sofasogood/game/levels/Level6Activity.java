...
public class Level6Activity extends AppCompatActivity {
    ...
    private final String[] dialogs = {
            "Balcony's breezy and beautiful! What's next?",
            "The guest room has two sofas to arrange — tricky!",
            "I need to think carefully about the order here.",
            "One wrong push and everything gets stuck.",
            "Focus… let's do this!"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getBooleanExtra("skipDialog", false)) {
            ...
            gameView.loadLevel(LevelData.LEVEL_6);
        } else {
            dialogBox.setText(dialogs[dialogIndex]);
        }

        findViewById(R.id.level6Root).setOnClickListener(v -> {
        ...
        gameView.setOnLevelCompleteListener(() -> {
            ...
            result.putExtra("nextLevel", "com.speed.sofasogood.game.levels.Level7Activity");
